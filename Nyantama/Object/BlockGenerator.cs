...
public class BlockGenerator : MonoBehaviour
{
    ...
    private enum BlockType { Grass, Wood , Brick , Stone ,Event, Evect2, Metal, Brick2, Brick3, Plaid , Wood2, Stone2, Float
            , Stone3, Stone4, Stone5, Stone6, Wood3, Pattern1, Float2, Pattern2 ,Spacial1, Spacial2 }
    ...
    private void SetUV(GameObject cube)
    {
        if (Element == BlockElement.Normal)
        {
            ...
            if (Type == BlockType.Spacial1) cube.GetComponent<MeshFilter>().mesh.uv = GetBlockUVs(0, 3);
            if (Type == BlockType.Spacial2) cube.GetComponent<MeshFilter>().mesh.uv = GetBlockUVs(5, 1);
        }
        if (Element == BlockElement.Damage)
        {
