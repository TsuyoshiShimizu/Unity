...
public class AudioManager : MonoBehaviour
{
    ...
    [SerializeField] private AudioClip StageSelectBGM = null;
   ...
   // private int playSECount = 0;
    ...
    {
        BGMPlayer.volume = GameManager.eventCount[0] / 100.0f;
    }
    ...
    {
        LoopSEPlayer.volume = GameManager.eventCount[1] / 100.0f;
        SEPlayer.volume = GameManager.eventCount[1] / 100.0f;
    }
